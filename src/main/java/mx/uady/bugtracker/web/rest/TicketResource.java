...
import mx.uady.bugtracker.domain.Ticket;
import mx.uady.bugtracker.repository.TicketRepository;
...
/**
 * REST controller for managing {@link mx.uady.bugtracker.domain.Ticket}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TicketResource {
    ...
    /**
     * {@code GET  /tickets/self} : get all the tickets assigned to logged in user.
     *
     * @param pageable the pagination information.
     * @param eagerload flag to eager load entities from relationships (This is applicable for many-to-many).
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of tickets in body.
