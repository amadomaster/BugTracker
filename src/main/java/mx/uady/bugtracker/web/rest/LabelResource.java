...
import mx.uady.bugtracker.domain.Label;
import mx.uady.bugtracker.repository.LabelRepository;
...
/**
 * REST controller for managing {@link mx.uady.bugtracker.domain.Label}.
 */
@RestController
@RequestMapping("/api")
@Transactional
